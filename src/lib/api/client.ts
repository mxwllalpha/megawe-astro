...
class ApiClient {
  ...
  private transformJobData(job: any): Job {
    return {
      ...
      company_logo_uri: job.company_logo_uri || job.logo || job.company_logo,
  ...
  private transformEmployerData(company: any): Employer {
    return {
      ...
      company_logo_uri: company.company_logo_uri || company.logo || company.company_logo || '',
      ...
      return [
        {
          ...
          company_logo_uri: '/src/assets/images/default-company-logo.svg',
